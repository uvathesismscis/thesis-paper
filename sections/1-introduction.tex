...
The perceived comfort of occupants is influenced by the overall Indoor Environmental Quality (IEQ) consisting of several key metrics (e.g. mechanical ventilation, temperature regulation, natural lighting) to create a combined IEQ index for a specific indoor space \cite{kulshreshtha_indoor_2024}. One core metric for the quality of the indoor environment is the afore mentioned quality of indoor air and deserves special attention because of it's invisibility to occupants \cite{son_perceived_2023}, polluted air is not easily detected by smell or sight. 

Additionally, mechanical ventilation systems in buildings operate discreetly and are often insufficent at ventilation in densely occupied small rooms such as meeting rooms, lab offices or hot-desking working areas \cite{silva_post-occupancy_2017} contributing to occupants' perceived lack of control since these systems are typically automated \cite{persily_challenges_2015} and cannot be directly regulated or controlled by occupants themselves \cite{kim_automatic_2019}. 

This creates an interplay between occupants' effects on comfort, built environments, and computing technologies (see Figure \ref{fig:complexity}) researched in a overarching field of study called Human-Building Interaction (HBI) \cite{alavi_introduction_2019}. This research specifically focuses on understanding occupants' needs through in-the-wild \cite{rogers_moving_2017} studies gaining insight into occupants awareness, collecting indoor air quality data in designated spaces, prototyping data physicalization devices to visualize indoor air quality and using these designs as a data probing tool \cite{zimmerman_research_2007} evaluating their effectiveness with the overall goal of gathering insights into occupants' comfort levels and helping them to take preventive action \cite{zhong_complexity_2021} against poor indoor air quality. 
