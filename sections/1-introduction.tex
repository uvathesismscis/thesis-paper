...
\begin{enumerate}
    ...
    \item \emph{How can environmental information related to indoor air quality be incorporated into a physical data-driven representation in the form of a design artefact?}\label{subq:2}
    \item \emph{How does the post-installation evaluation of a prototype design solution impact occupants' awareness and their willingness to adopt preventive measures?}\label{subq:3}\\
\end{enumerate}