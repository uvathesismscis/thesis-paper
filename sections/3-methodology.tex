...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.5\textwidth]{prototype_impressions.png}
    \caption{Impressions of the prototyping and ideations phase. A) 3D printing models B) Testing servo motors C) Writing firmware code}
