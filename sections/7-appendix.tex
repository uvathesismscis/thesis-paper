...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\paperwidth]{Concept-1_Aspen_Design_Diagram.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\paperwidth]{Concept-2_Bluebird_Design_Diagram.jpg}
    \caption{Design diagram of Concept-2}
    \label{fig:timeline}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\paperwidth]{Concept-3_Crocus_Design_Diagram.jpg}
