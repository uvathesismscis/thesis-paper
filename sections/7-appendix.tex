...
\begin{table}[htbp]
    ...
    \caption{\textit{Demographics and role}\\ First I'm going to ask some question about your demographics and use of this building.}
    \label{tab:column_widths}
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \multicolumn{1}{|p{0.33\textwidth}|}{\textbf{Description}} & \multicolumn{1}{p{0.6\textwidth}|}{\textbf{Questions}} \\
        \hline
        Demographics to have a diverse sample size & \textbf{Q1:} What is your age?\
        \textbf{Q2:} What gender do you identify with?\ \textbf{Q3:} What is your nationality? \textbf{Q4:} What is your level of education? \\
        \hline
        Understanding the role of the occupant within the building, & 
        \textbf{Q4:} What do you do in daily life? \textbf{Q5:} How would you describe your role within this building? \textbf{Q6:} Where are you located in the building? \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    \captionsetup{justification=raggedright,singlelinecheck=false}
    \caption{\textit{Activity and frequency} \\ Now some questions about your activity within this building and how you use meeting rooms.}
    \label{tab:column_widths}
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \multicolumn{1}{|p{0.33\textwidth}|}{\textbf{Description}} & \multicolumn{1}{p{0.6\textwidth}|}{\textbf{Questions}} \\
        \hline
        Understanding the frequency of activity & \textbf{Q6:} How often do you use this building for various activities? \textbf{Q7:} What do you usually use the building for? \\
        \hline
        Understanding the frequency of meetings & \textbf{Q8:} On average how many meetings do you have per week? \textbf{Q9:} On average how long is a typical meeting? \textbf{Q10:} What locations do you typically use for your meetings?\\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    \captionsetup{justification=raggedright,singlelinecheck=false}
    \caption{\textit{Notion of Indoor Air Quality (IAQ)}\\\ Lastly some question about your notion of indoor air quality as a baseline.}
    \label{tab:column_widths}
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \multicolumn{1}{|p{0.33\textwidth}|}{\textbf{Description}} & \multicolumn{1}{p{0.6\textwidth}|}{\textbf{Questions}} \\
        \hline
        Understanding the IAQ awareness & \textbf{Q11:} How aware are you of the current IAQ in this space? \textbf{Q12:} How do you perceive the IAQ in this space? \\
        \hline
        Understanding cognitive and health symptons & \textbf{Q13:} Have you ever experienced cognitive symptons you think are related to indoor air quality in a meeting room? \textbf{Q14:} Have you ever experienced health symptons you think are related to indoor air quality in a meeting room? \\
        \hline
    \end{tabularx}
\end{table}
...
We will move on to testing the prototype. Please imagine you are an occupant having a meeting in the space (meeting room) we are currently in. As you might have noticed on the wall, a prototype of a data physicalization is hung up.\\

\begin{table}[htbp]
    \captionsetup{justification=raggedright,singlelinecheck=false}
    \caption{\textit{Description of the prototype} \\ To gather some first impressions I would like to get some description of the prototype based on your view of it.}
    \label{tab:column_widths}
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \multicolumn{1}{|p{0.33\textwidth}|}{\textbf{Experiment}} & \multicolumn{1}{p{0.6\textwidth}|}{\textbf{Questions}} \\
        \hline
        1) Does the user give a good description of the prototype? & \textbf{Q1:} Could you describe in your own words what you think you see?\
        \textbf{Q2:} What do you think the prototype communicates to you as an occupant?\\
        \hline
        2) Does the user give a good description of the look and feel? & 
        \textbf{Q3:} What do you think of the overall design of the physical artefact? \textbf{Q4:} What do you think of the use of materials and look and feel of the artefact? \\
        \hline
    \end{tabularx}
\end{table}
