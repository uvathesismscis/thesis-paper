...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{building_outside_left.jpg}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{building_outside_right.jpg}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{building_planters_atrium-squares.jpg}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{building_planters_atrium-strings.jpg}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{building_planters_informal_space.jpg}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{building_planters_working-spaces.jpg}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{} *{11}{c} @{}}
        \toprule
        \textbf{Date} & \textbf{Time} & \textbf{CO$_{2}$} & \textbf{Temp} & \textbf{RH} & \textbf{PM1.0} & \textbf{PM2.5} & \textbf{PM10} & \textbf{TVOC} & \textbf{BP} & \textbf{O3} \\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{@{} *{11}{c} @{}}
        \toprule
        \textbf{Date} & \textbf{Time} & \textbf{Temp} & \textbf{RH} & \textbf{DewPoint} & \textbf{CO$_{2}$} & \textbf{-} & \textbf{-} & \textbf{-} & \textbf{-} & \textbf{-} \\
        \midrule
